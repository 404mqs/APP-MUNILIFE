...
const buttons = [
  { name: 'Reclamos', icon: 'exclamation-circle', page: 'Claims' },
  { name: 'Denuncias', icon: 'bullhorn', page: 'Complaints' },
  { name: 'Home', icon: 'home', page: 'Home' },
  { name: 'Comercios', icon: 'shopping-cart', page: 'Shops' },
  { name: 'Servicios', icon: 'question-circle', page: 'Services' },
];
